...
export class SuperHeroesService {
  ...
  superHeroes$ = this.http
    .get<SuperHero[]>(`${environment.apiUrl}/superHeroes`)
    .pipe(
      catchError((error) => {
        console.log(error);
  ...
  searchSuperHero(keyWord: string): Observable<SuperHero[]> {
    return this.http
      .get<SuperHero[]>(
        `${environment.apiUrl}/superHeroes?name_like=${keyWord}`
      )
      .pipe(
        catchError((error) => {
          console.log(error);
  ...
  addNewSuperHero(hero: SuperHero): Observable<SuperHero> {
    return this.http
      .post<SuperHero>(`${environment.apiUrl}/superHeroes`, hero)
      .pipe(
        catchError((error) => {
          console.log(error);
  ...
  updateSuperHero(hero: SuperHero): Observable<SuperHero> {
    return this.http
      .patch<SuperHero>(`${environment.apiUrl}/superHeroes/${hero.id}`, hero)
      .pipe(
        catchError((error) => {
          console.log(error);
  ...
  getSuperHeroById(heroId: number): Observable<SuperHero> {
    return this.http
      .get<SuperHero>(`${environment.apiUrl}/superHeroes/${heroId}`)
      .pipe(
        catchError((error) => {
          console.log(error);
          throw new Error('Could not retrieve data');
  ...
  deleteSuperHero(heroId: number): Observable<SuperHero> {
    return this.http
      .delete<SuperHero>(`${environment.apiUrl}/superHeroes/${heroId}`)
      .pipe(
        catchError((error) => {
          console.log(error);
